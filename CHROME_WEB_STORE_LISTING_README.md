# Chrome Web Store Listing README

Use this file as the source of truth for Chrome Web Store listing text and policy copy.
...
- Icon: `128x128` extension icon is included in the package
...
## 4) Single-purpose description (paste-ready)
